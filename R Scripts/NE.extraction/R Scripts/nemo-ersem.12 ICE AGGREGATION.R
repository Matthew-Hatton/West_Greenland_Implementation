...
temp <- readRDS(paste0("./Objects/NEMO RAW/NE_Months_Ice/NE.ICE.",Force,".hist.1976.01.rds")) %>% 
  group_by(Shore) %>% 
...
all_files <- list.files("./Objects/NEMO RAW/NE_Months_Ice/", pattern = ".rds", full.names = TRUE) %>%
