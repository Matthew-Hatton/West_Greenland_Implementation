...
contours <- readRDS("./Objects/domain/Bathymetry_lines.rds")                       # Get the contours

points <- readRDS("./Objects/domain/Bathymetry_points.rds") %>%                    # Get bathymetry
...
saveRDS(points_proj, file = "./Objects/domain/Bathymetry_points_proj.rds")
...
saveRDS(contours_proj, file = "./Objects/domain/Bathymetry_lines_proj.rds")
...
grid_map <- ggplot() +
  ...
  NULL
ggsave_map("./Figures/domain/GEBCO grid.png", grid_map)
...
line_map <- ggplot() +
  ...
  NULL
ggsave_map("./Figures/domain/GEBCO lines.png", line_map)
