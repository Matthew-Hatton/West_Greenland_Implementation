...
ggplot(area) +                                                              # Check the polygons match correctly with points
  ...
  NULL
ggsave_map("./Figures/saltless/NM/check.04.2.png", plot = last_plot())
...
ggsave("./Figures/saltless/NM/check.04.3.png", plot = last_plot())
...
saveRDS(summary, "./Objects/rivers/NM/NM.River volume input.rds")
